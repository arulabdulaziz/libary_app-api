...
Route.post('test', 'VolumesController.test')
...
Route.group(() => {
  Route.group(() => {
    ...
    Route.post('book/:id', 'BooksController.updateWithCover')
    Route.delete('book_force_delete/:id', 'BooksController.destroyForce')
    ...
    Route.post('volume/:id', 'VolumesController.updateWithCover')
    Route.delete('volume_force_delete/:id', 'VolumesController.destroyForce')
